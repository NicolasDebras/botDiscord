...
DEFAULT_TEMPLATES: dict[str, dict] = {
    ...
    "MiddleScale de G3 LE GOAT": {
        ...
        "weapon_pf2": {
            "TANK":    "Second Repack (×1)  ·  1h arcane / heavy (×1)  ·  Equilibre (×1)  ·  GA (×1)",
            "SUPPORT": "Locus (×1)  ·  Garde-Serment (×2)  ·  Damnation (×1)",
            "HEAL":    "Exalté (×1)  ·  Sancti cuir (×2)  ·  1h nature (×1)",
            "DPS":     "Spirit (×1)  ·  Perma (×1)  ·  Aria (×1)  ·  Brassards (×infini)",
        },
    },
    "MONKEY BANANA": {
